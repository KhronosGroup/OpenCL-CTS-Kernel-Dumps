        ...
        __kernel void test_pipe_subgroup_write_int4(__global int4 *src, __write_only pipe int4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_int4(__read_only pipe int4 in_pipe, __global int4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
