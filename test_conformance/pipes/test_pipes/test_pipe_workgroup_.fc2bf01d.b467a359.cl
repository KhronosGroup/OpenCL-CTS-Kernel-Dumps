        ...
        __kernel void test_pipe_workgroup_write_short8(__global short8 *src, __write_only pipe short8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_short8(__read_only pipe short8 in_pipe, __global short8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
