        ...
        __kernel void test_pipe_subgroup_write_ulong(__global ulong *src, __write_only pipe ulong out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_ulong(__read_only pipe ulong in_pipe, __global ulong *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
