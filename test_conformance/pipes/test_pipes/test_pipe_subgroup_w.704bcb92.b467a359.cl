        ...
        __kernel void test_pipe_subgroup_write_uint4(__global uint4 *src, __write_only pipe uint4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_uint4(__read_only pipe uint4 in_pipe, __global uint4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
