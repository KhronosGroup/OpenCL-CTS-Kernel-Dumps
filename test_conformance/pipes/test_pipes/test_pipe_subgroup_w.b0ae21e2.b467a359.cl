        ...
        __kernel void test_pipe_subgroup_write_short(__global short *src, __write_only pipe short out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_short(__read_only pipe short in_pipe, __global short *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
