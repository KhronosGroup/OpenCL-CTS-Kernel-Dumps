        ...
        __kernel void test_pipe_workgroup_write_double4(__global double4 *src, __write_only pipe double4 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_double4(__read_only pipe double4 in_pipe, __global double4 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
