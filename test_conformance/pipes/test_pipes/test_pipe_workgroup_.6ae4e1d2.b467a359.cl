        ...
        __kernel void test_pipe_workgroup_write_short16(__global short16 *src, __write_only pipe short16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_short16(__read_only pipe short16 in_pipe, __global short16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
