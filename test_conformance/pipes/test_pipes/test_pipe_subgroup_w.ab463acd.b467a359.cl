        ...
        __kernel void test_pipe_subgroup_write_ushort2(__global ushort2 *src, __write_only pipe ushort2 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_ushort2(__read_only pipe ushort2 in_pipe, __global ushort2 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
