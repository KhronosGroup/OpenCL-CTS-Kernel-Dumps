        ...
        __kernel void test_pipe_subgroup_write_char(__global char *src, __write_only pipe char out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_char(__read_only pipe char in_pipe, __global char *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
