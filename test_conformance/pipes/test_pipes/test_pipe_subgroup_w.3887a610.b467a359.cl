        ...
        __kernel void test_pipe_subgroup_write_ushort16(__global ushort16 *src, __write_only pipe ushort16 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_ushort16(__read_only pipe ushort16 in_pipe, __global ushort16 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
