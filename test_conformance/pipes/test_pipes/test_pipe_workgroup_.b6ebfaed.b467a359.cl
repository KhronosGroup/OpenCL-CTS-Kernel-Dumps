        ...
        __kernel void test_pipe_workgroup_write_long8(__global long8 *src, __write_only pipe long8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_long8(__read_only pipe long8 in_pipe, __global long8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
