        ...
        __kernel void test_pipe_subgroup_write_float(__global float *src, __write_only pipe float out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_float(__read_only pipe float in_pipe, __global float *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
