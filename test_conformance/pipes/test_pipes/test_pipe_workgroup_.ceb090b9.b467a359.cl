        ...
        __kernel void test_pipe_workgroup_write_double2(__global double2 *src, __write_only pipe double2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_double2(__read_only pipe double2 in_pipe, __global double2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
