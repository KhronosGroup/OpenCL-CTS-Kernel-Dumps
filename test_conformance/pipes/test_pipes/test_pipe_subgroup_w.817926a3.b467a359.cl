        ...
        __kernel void test_pipe_subgroup_write_int(__global int *src, __write_only pipe int out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_int(__read_only pipe int in_pipe, __global int *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
