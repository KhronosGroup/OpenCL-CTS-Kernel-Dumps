#pragma OPENCL EXTENSION cl_khr_fp16 : enable
        ...
        __kernel void test_pipe_workgroup_write_half8(__global half8 *src, __write_only pipe half8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_half8(__read_only pipe half8 in_pipe, __global half8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
