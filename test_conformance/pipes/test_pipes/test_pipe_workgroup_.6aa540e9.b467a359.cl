#pragma OPENCL EXTENSION cl_khr_fp16 : enable
        ...
        __kernel void test_pipe_workgroup_write_half(__global half *src, __write_only pipe half out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_half(__read_only pipe half in_pipe, __global half *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
