        ...
        __kernel void test_pipe_workgroup_write_ulong16(__global ulong16 *src, __write_only pipe ulong16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_ulong16(__read_only pipe ulong16 in_pipe, __global ulong16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
