        ...
        __kernel void test_pipe_workgroup_write_ushort(__global ushort *src, __write_only pipe ushort out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_ushort(__read_only pipe ushort in_pipe, __global ushort *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
