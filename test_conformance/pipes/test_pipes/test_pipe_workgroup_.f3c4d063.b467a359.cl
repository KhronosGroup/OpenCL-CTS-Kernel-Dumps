        ...
        __kernel void test_pipe_workgroup_write_ulong2(__global ulong2 *src, __write_only pipe ulong2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_ulong2(__read_only pipe ulong2 in_pipe, __global ulong2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
