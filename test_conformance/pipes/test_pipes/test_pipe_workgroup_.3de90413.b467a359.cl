        ...
        __kernel void test_pipe_workgroup_write_short2(__global short2 *src, __write_only pipe short2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_short2(__read_only pipe short2 in_pipe, __global short2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
