        ...
        __kernel void test_pipe_workgroup_write_float8(__global float8 *src, __write_only pipe float8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_float8(__read_only pipe float8 in_pipe, __global float8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
