        ...
        __kernel void test_pipe_workgroup_write_ushort2(__global ushort2 *src, __write_only pipe ushort2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_ushort2(__read_only pipe ushort2 in_pipe, __global ushort2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
