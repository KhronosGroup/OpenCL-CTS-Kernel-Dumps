        ...
        __kernel void test_pipe_workgroup_write_long16(__global long16 *src, __write_only pipe long16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_long16(__read_only pipe long16 in_pipe, __global long16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
