        ...
        __kernel void test_pipe_workgroup_write_long4(__global long4 *src, __write_only pipe long4 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_long4(__read_only pipe long4 in_pipe, __global long4 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
