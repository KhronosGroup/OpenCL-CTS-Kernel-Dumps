        ...
        __kernel void test_pipe_workgroup_write_uchar(__global uchar *src, __write_only pipe uchar out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_uchar(__read_only pipe uchar in_pipe, __global uchar *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
