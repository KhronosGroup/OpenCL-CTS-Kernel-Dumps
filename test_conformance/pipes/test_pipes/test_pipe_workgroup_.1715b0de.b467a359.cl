        ...
        __kernel void test_pipe_workgroup_write_double8(__global double8 *src, __write_only pipe double8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_double8(__read_only pipe double8 in_pipe, __global double8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
