        ...
        __kernel void test_pipe_subgroup_write_short4(__global short4 *src, __write_only pipe short4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_short4(__read_only pipe short4 in_pipe, __global short4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
