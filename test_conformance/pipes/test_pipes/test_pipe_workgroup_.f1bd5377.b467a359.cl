        ...
        __kernel void test_pipe_workgroup_write_int2(__global int2 *src, __write_only pipe int2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_int2(__read_only pipe int2 in_pipe, __global int2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
