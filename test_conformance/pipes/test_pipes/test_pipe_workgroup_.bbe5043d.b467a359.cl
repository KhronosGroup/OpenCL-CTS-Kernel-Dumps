        ...
        __kernel void test_pipe_workgroup_write_int16(__global int16 *src, __write_only pipe int16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_int16(__read_only pipe int16 in_pipe, __global int16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
