        ...
        __kernel void test_pipe_workgroup_write_uint(__global uint *src, __write_only pipe uint out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_uint(__read_only pipe uint in_pipe, __global uint *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
