        ...
        __kernel void test_pipe_workgroup_write_uchar2(__global uchar2 *src, __write_only pipe uchar2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_uchar2(__read_only pipe uchar2 in_pipe, __global uchar2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
