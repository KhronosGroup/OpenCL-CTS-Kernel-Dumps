        ...
        __kernel void test_pipe_subgroup_write_uint16(__global uint16 *src, __write_only pipe uint16 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_uint16(__read_only pipe uint16 in_pipe, __global uint16 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
