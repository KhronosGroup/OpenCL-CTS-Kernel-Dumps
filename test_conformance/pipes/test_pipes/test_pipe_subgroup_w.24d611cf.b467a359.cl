        ...
        __kernel void test_pipe_subgroup_write_char2(__global char2 *src, __write_only pipe char2 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_char2(__read_only pipe char2 in_pipe, __global char2 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
