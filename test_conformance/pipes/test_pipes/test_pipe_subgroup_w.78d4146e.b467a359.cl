        ...
        __kernel void test_pipe_subgroup_write_uchar4(__global uchar4 *src, __write_only pipe uchar4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_uchar4(__read_only pipe uchar4 in_pipe, __global uchar4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
