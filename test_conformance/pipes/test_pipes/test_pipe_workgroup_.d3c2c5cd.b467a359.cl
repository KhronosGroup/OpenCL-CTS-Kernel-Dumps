        ...
        __kernel void test_pipe_workgroup_write_uint2(__global uint2 *src, __write_only pipe uint2 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_uint2(__read_only pipe uint2 in_pipe, __global uint2 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
