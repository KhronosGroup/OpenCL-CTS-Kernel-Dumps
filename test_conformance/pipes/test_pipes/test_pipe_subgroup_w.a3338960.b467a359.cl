        ...
        __kernel void test_pipe_subgroup_write_uchar16(__global uchar16 *src, __write_only pipe uchar16 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_uchar16(__read_only pipe uchar16 in_pipe, __global uchar16 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
