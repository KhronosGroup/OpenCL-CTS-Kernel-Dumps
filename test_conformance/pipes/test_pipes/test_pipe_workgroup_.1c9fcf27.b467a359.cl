        ...
        __kernel void test_pipe_workgroup_write_double16(__global double16 *src, __write_only pipe double16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_double16(__read_only pipe double16 in_pipe, __global double16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
