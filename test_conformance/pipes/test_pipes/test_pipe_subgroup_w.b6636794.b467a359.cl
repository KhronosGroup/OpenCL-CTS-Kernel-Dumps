        ...
        __kernel void test_pipe_subgroup_write_char8(__global char8 *src, __write_only pipe char8 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_char8(__read_only pipe char8 in_pipe, __global char8 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
