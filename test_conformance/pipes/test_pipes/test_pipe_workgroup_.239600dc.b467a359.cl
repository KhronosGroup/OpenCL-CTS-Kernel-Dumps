        ...
        __kernel void test_pipe_workgroup_write_double(__global double *src, __write_only pipe double out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_double(__read_only pipe double in_pipe, __global double *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
