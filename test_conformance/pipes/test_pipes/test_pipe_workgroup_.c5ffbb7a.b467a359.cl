        ...
        __kernel void test_pipe_workgroup_write_int8(__global int8 *src, __write_only pipe int8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_int8(__read_only pipe int8 in_pipe, __global int8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
