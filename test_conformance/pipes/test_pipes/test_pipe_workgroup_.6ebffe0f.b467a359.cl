        ...
        __kernel void test_pipe_workgroup_write_float16(__global float16 *src, __write_only pipe float16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_float16(__read_only pipe float16 in_pipe, __global float16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
