        ...
        __kernel void test_pipe_subgroup_write_ulong4(__global ulong4 *src, __write_only pipe ulong4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_ulong4(__read_only pipe ulong4 in_pipe, __global ulong4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
