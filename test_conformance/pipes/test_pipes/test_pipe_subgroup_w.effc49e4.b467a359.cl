        ...
        __kernel void test_pipe_subgroup_write_char16(__global char16 *src, __write_only pipe char16 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_char16(__read_only pipe char16 in_pipe, __global char16 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
