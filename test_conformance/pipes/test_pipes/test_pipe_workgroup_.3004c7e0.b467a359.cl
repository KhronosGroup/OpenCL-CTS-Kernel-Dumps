        ...
        __kernel void test_pipe_workgroup_write_uchar16(__global uchar16 *src, __write_only pipe uchar16 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_uchar16(__read_only pipe uchar16 in_pipe, __global uchar16 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
