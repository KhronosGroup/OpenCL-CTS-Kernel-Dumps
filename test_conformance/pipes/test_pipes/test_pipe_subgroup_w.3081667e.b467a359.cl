        ...
        __kernel void test_pipe_subgroup_write_int2(__global int2 *src, __write_only pipe int2 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_int2(__read_only pipe int2 in_pipe, __global int2 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
