        ...
        __kernel void test_pipe_subgroup_write_long(__global long *src, __write_only pipe long out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_long(__read_only pipe long in_pipe, __global long *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
