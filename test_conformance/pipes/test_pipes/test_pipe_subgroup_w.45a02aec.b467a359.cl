        ...
        __kernel void test_pipe_subgroup_write_uchar(__global uchar *src, __write_only pipe uchar out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_uchar(__read_only pipe uchar in_pipe, __global uchar *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
