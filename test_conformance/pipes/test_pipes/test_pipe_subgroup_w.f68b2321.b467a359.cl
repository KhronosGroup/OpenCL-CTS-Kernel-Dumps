        ...
        __kernel void test_pipe_subgroup_write_ushort8(__global ushort8 *src, __write_only pipe ushort8 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_ushort8(__read_only pipe ushort8 in_pipe, __global ushort8 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
