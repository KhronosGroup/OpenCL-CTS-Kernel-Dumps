        ...
        __kernel void test_pipe_workgroup_write_int(__global int *src, __write_only pipe int out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_int(__read_only pipe int in_pipe, __global int *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
