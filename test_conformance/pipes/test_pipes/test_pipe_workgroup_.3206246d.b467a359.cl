        ...
        __kernel void test_pipe_workgroup_write_ulong8(__global ulong8 *src, __write_only pipe ulong8 out_pipe)
        {
        ...
        __kernel void test_pipe_workgroup_read_ulong8(__read_only pipe ulong8 in_pipe, __global ulong8 *dst)
        {
            int gid = get_global_id(0);
            __local reserve_id_t res_id;
