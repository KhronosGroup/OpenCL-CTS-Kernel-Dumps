        ...
        __kernel void test_pipe_subgroup_write_char4(__global char4 *src, __write_only pipe char4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_char4(__read_only pipe char4 in_pipe, __global char4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
