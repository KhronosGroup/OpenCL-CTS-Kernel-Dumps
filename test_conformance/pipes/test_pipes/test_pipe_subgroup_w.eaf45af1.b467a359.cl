        ...
        __kernel void test_pipe_subgroup_write_float4(__global float4 *src, __write_only pipe float4 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_float4(__read_only pipe float4 in_pipe, __global float4 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
