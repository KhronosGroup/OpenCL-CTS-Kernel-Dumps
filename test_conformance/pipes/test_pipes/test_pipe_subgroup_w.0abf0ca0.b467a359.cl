        ...
        __kernel void test_pipe_subgroup_write_long2(__global long2 *src, __write_only pipe long2 out_pipe)
        {
        ...
        __kernel void test_pipe_subgroup_read_long2(__read_only pipe long2 in_pipe, __global long2 *dst)
        {
            int gid = get_global_id(0);
            reserve_id_t res_id;
